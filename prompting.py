...
Тикер | Отскок | Решение | Почему сегодня | Риск
TICKER | NN/100 | ДА/НЕТ | кратко | кратко

Сегодня лучше избегать (3-6):
Актив | Отскок | Решение | Почему избегать | Риск
ASSET | NN/100 | ДА/НЕТ | кратко | кратко
...
- Для КАЖДОГО пункта в секциях "Лист наблюдения на сегодня" и "Сегодня лучше избегать" обязательно заполняй поле "Отскок" как NN/100 и поле "Решение" как ДА/НЕТ, где NN — целое число от 1 до 100.
